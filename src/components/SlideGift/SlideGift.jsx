            ...
            <div className="c-grid c-grid--row c-grid--between">
                <div className="c-grid-col c-grid-col-5">
                    <div className="c-text">
                        ...
                        <p>
                        Помимо этого будет много интересных гаджетов: кофемашина капсульного типа Philips, беспроводные наушники JBL, 
                        внешний аккумулятор Xiaomi, портативная колонка JBL, Яндекс Станция, термокружки, 
